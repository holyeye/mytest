package refactoring.ex4;

import java.text.ParseException;
import java.util.*;

/**
 * Args: 자체 리팩토링을 끝낸 버전(여기선 Exception 처리는 없음) (boolean, String, int)
 * 
 */
public class ArgsRefactoringEx4 {
	...
	public ArgsRefactoringEx4(String schema, String[] args) throws ParseException {
		this.schema = schema;
